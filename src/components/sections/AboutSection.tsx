  ...
  return (
    <div className="text-white">
      ...
      <div className="space-y-6 text-gray-300 leading-relaxed">
        <p>
          I'm a data scientist and an engineer who enjoy building end to end AI systems.
        </p>
        ...
        <p>
          When I'm not working, I'm usually sketching product ideas, experimenting with 
          new tools, or designing something visual just for fun.
        </p>
      </div>
    </div>
  );
